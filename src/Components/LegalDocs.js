  ...
  return (
    <div className="legal-section-title">
      <h1 className="legal-siteTitle">
        <Link to="/">
        Global Spine Care <span className="legal-siteSign"></span>
        </Link>
      </h1>
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Global Spine Care, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Global Spine Care, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Global Spine Care is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2024 Global Spine Care. All rights reserved.</p>
      </div>
    </div>
  );
}
